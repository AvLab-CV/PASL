...
class TestData(Dataset):
    def __init__(self, detector, img_list, iscrop=True, crop_size=224, scale=1.25, face_detector='fan', sample_step=10):
        '''
        ...
        # elif os.path.isfile(testpath) and (testpath[-3:] in ['txt']):
        #      with open(testpath, 'r', encoding='utf-8') as file:
        #     # 读取文件的每一行并存储在列表中，去除每行末尾的换行符
        #         self.imagepath_list = [line.rstrip('\n') for line in file.readlines()]
        # else:
        ...
        #----------------------for pair-----------------------------------
        # temp = []
        # for i in self.imagepath_list:
        #     temp.extend(i.split(' '))
        # self.imagepath_list = temp
