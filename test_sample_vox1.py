...
import torch
from core.solver_lm_perceptual_vox1 import Solver
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume_iter', type=int, default=355000,
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./experiment/vox1',
                        help='Directory for saving network checkpo0ints')

    # directory for calculating metrics
    parser.add_argument('--eval_dir', type=str, default='./expr/eval/vox1',
    ...
    if args.dataset == 'mpie':
        ...
        if args.multi:
            ...
            args.val_img_dir = './train_list/test_self_vox1_clean.txt'
